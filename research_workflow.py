...
Usage:
    ...
    python3 research_workflow.py read-paper DOI_or_arxiv_id
    python3 research_workflow.py verify "claim" --doi "..."
    python3 research_workflow.py full-analysis "topic" [--read-papers]
    python3 research_workflow.py bibliography --output bib_verify.json
"""
...
def main():
    ...
    if command == "search":
        ...
        if len(sys.argv) < 3:
            print("Usage: python3 research_workflow.py read-paper <DOI> | <arxiv_id> | <PMC_id>")
            return
        ...
        if len(sys.argv) < 3:
            print("Usage: python3 research_workflow.py verify \"claim\" --doi \"...\"")
            return
        ...
        if len(sys.argv) < 3:
            print("Usage: python3 research_workflow.py full-analysis \"topic\" [--read-papers]")
            return
